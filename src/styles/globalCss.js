...
export const globalCss = `
  ...
  @media (max-width:768px) {
    ...
    .hero-cta-row { position:relative; bottom:auto; left:auto; transform:none; flex-direction:column; align-items:center; width:calc(100% - 48px); max-width:320px; margin-top:16px; gap:10px; }
    .hero-cta-row button { width:100%; box-sizing:border-box; text-align:center; justify-content:center; }
